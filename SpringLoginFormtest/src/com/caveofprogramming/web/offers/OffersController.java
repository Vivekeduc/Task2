...
public class OffersController {
	...
	public String addUser(@ModelAttribute("user")User user, Model model){
		System.out.println(user.getUserId());String resultString2;
		
		Boolean result = userdao.addUser(user);
		
		if(result){
			resultString2 ="Details Saved!!";
			
		}
		
		else{
			resultString2="Failed to save details";
		}
		model.addAttribute("resultString2",resultString2);
		return "success2";
	}
